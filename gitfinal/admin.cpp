...
void admin::on_pb_ajouter_7_clicked()
{
    ...
    smtp->sendMail("houssemjrad94@gmail.com",ui->comboBox_mail->currentText(),ui->subject->text(),ui->msg->toPlainText());
}
...
if (test) //si test true
{
 ...
 //envoyer mail
 QString text = "Bonjour Monsieur/Madame, \n\nVous avez passer une commande  \n\n"
                "Vous etes toujours les bienvenues " + code +" \n\n Si vou souhaitez annuler la commande contacter nous.\n\n"
                                                          " Cordialement,\n L'Equipe OTOM";
 Smtp* smtp = new Smtp("houssemjrad94@gmail.com","03101919","smtp.gmail.com",465);
 connect(smtp, SIGNAL(status(QString)), this, SLOT(mailSent(QString)));
 smtp->sendMail("houssemjrad94@gmail.com",ui->lineEdit_c_2->text(),"Reinitialisation mot de passe Smart Pastry Shop",text );
