...
ChatWindow::ChatWindow(QWidget *parent)
    ...
    , m_chatClient(new Clientm(this))
    , m_chatModel(new QStandardItemModel(this))
{
    ui->setupUi(this);
    m_chatModel->insertColumn(0);
    ui->chatView->setModel(m_chatModel);
    connect(m_chatClient, &Clientm::connected, this, &ChatWindow::connectedToServer);
    connect(m_chatClient, &Clientm::loggedIn, this, &ChatWindow::loggedIn);
    connect(m_chatClient, &Clientm::loginError, this, &ChatWindow::loginFailed);
    connect(m_chatClient, &Clientm::messageReceived, this, &ChatWindow::messageReceived);
    connect(m_chatClient, &Clientm::disconnected, this, &ChatWindow::disconnectedFromServer);
    connect(m_chatClient, &Clientm::error, this, &ChatWindow::error);
    connect(m_chatClient, &Clientm::userJoined, this, &ChatWindow::userJoined);
    connect(m_chatClient, &Clientm::userLeft, this, &ChatWindow::userLeft);
