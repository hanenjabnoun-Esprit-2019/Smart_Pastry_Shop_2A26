...
Employer::Employer()
{
id=0; nom=""; prenom=""; id_depp=0; numero=0; salaire=0; service=""; mdp="";
}
Employer::Employer(int id, QString nom, QString prenom, float salaire, long numero, int id_depp, QString service, QString mdp)
{
    this->id=id;
    this->nom=nom;
    this->prenom=prenom;
...
bool Employer::ajouter()
{
    ...
    QString id_depp_string=QString::number(id_depp);
        ...
        query.prepare("INSERT INTO employer (id, nom, prenom,salaire,numero,id_depp,service,mdp) "
                  "VALUES (:id, :nom, :prenom, :salaire, :numero, :id_depp, :service, :mdp)");
