    ...
    ui(new Ui::User)
{
    ...
    ui->client->setGeometry(60,230,131,71);
    ui->commande->setGeometry(60,290,131,71);
  /*  ui->employe->setGeometry(60,310,131,71);
    ui->fournisseur->setGeometry(60,370,131,71); */
    ui->maintenance->setGeometry(60,350,131,71);
...
void User::on_client_clicked()
{
    ui->stackedWidget->setCurrentIndex(0) ;
}

void User::on_commande_clicked()
{
    ui->stackedWidget->setCurrentIndex(1) ;
}


void User::on_maintenance_clicked()
{
...
void User::on_pb_ajouter_abonne_clicked()
{
...
void User::on_radioButton_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_supprimer_abonne_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_modifier_abonne_clicked()
{
...
void User::on_comboBox_4_activated()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_rechercher_abonne_textChanged()
{
...
void User::on_radioButton_5_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_radioButton_7_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_ajouter_abonnement_clicked()
{
...
void User::on_radioButton_3_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_supprimer_abonnement_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_modifier_abonnement_clicked()
{
...
void User::on_comboBox_7_activated()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::mailSent(QString status)
{
    if(status == "Message sent")
        N.mail_Abonnement();
}

void User::on_pb_ajouter_7_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
bool User::testmail(QString mail){
    int test=0;
...
void User::on_radioButton_6_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_radioButton_4_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_rechercher_abonnement_textChanged()
{
...
void User::on_refresh_2_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
           bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/HP/Desktop/Smart_Pastry_Shop_2A26/yassine/2.mp3"));
          if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pb_ajouter_clicked()
{
    QMessageBox msgBox;
...
void User::on_pb_update_clicked()
{
...
void User::on_pb_ajouter_depp_clicked()
{
    QMessageBox msgBox;
...
void User::on_pb_supp_depp_clicked()
{
    Deppartement D1;
...
void User::on_pb_chercher_clicked()
{
    ui->tab_employer->setModel(E.afficher());
...
void User::on_update_depp_clicked()
{
    Deppartement D1;
...
void User::on_pb_chercher_depp_clicked()
{
    ui->tab_depp->setModel(D.afficher());
...
void User::on_reset_employer_clicked()
{
    ui->tab_employer->setModel(E.afficher());
}

void User::on_reset_depp_clicked()
{
    ui->tab_depp->setModel(D.afficher());
}


void User::on_pdf_3_clicked()
{
...
void User::on_ajouterc_3_clicked()
{
...
void User::on_trier_6_clicked()
{
    ui->tableView_5->setModel(Etmp.trier());

}

void User::on_search_3_clicked()
{
...
void User::on_ajouterc_4_clicked()
{
    //recuperation d information
...
void User::on_pushButton_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
...
void User::on_pushButton_5_mou_clicked()
{
...
void User::on_pushButton_4_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/crud.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_6_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_2_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/crud.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_13_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_9_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/crud.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_14_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_15_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_tableView_3_mou_clicked(const QModelIndex &index)
{
...
void User::on_tableView_4_mou_clicked(const QModelIndex &index)
{
...
void User::on_pushButton_7_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_3_mou_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/ahmed/Documents/son projet/metier.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_10_mou_clicked()
{
    QString strStream;
...
void User::on_pushButton_11_mou_clicked()
{
    QString strStream;
                 QTextStream out(&strStream);
...
void User::on_pushButton_16_mou_clicked()
{
    QString strStream;
                 QTextStream out(&strStream);
...
void User::on_pushButton_8_mou_clicked()
{
...
//*************************** khalil *****************************
/*
void User::on_pushButton_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
...
void User::on_pushButton_5_kh_clicked()
{
...
void User::on_pushButton_4_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_6_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_2_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_13_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_9_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_8_kh_clicked()
{
...
void User::on_pushButton_14_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_10_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_15_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_tableView_3_kh_clicked(const QModelIndex &index)
{
...
void User::on_tableView_4_kh_clicked(const QModelIndex &index)
{
...
void User::on_pushButton_3_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
...
void User::on_pushButton_7_kh_clicked()
{
    QMediaPlayer * bulletsound = new QMediaPlayer();
       bulletsound->setMedia(QUrl::fromLocalFile("C:/Users/Khalil/Desktop/projet_1/rii/ze.mp3"));
      if (bulletsound->state() == QMediaPlayer::PlayingState){
